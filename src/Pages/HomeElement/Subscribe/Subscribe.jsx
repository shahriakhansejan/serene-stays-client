...
const Subscribe = () => {
  ...
  return (
    <div className="flex gap-12 items-center p-12 my-8 bg-[url('https://i.postimg.cc/x10c5hs9/pexels-pixabay-260922.jpg')] bg-black/50 bg-blend-multiply rounded-2xl bg-center container mx-auto">
      ...
      <div className="flex-1">
        <div className="">
          <div>
            <h1 className="text-[28px] text-white font-bold mb-3">
          ...
          <div className="">
            <form onSubmit={handleSubscribe} className="join">
              <input
                className="input input-bordered bg-white join-item"
                placeholder="Email"
